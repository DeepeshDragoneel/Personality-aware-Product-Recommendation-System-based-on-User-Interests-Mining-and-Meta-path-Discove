"""personality_aware_product_recommendation URL Configuration
...
from personality_aware_product_recommendation import settings
...
urlpatterns = [
    ...
    url(r'^Find_Recommendation_Prediction_Ratio/$', serviceprovider.Find_Recommendation_Prediction_Ratio, name="Find_Recommendation_Prediction_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^Predict_Recommendation_Details/$', serviceprovider.Predict_Recommendation_Details, name="Predict_Recommendation_Details"),
