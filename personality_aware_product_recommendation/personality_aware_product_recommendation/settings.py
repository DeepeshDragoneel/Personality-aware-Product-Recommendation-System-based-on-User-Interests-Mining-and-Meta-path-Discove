...
ROOT_URLCONF = 'personality_aware_product_recommendation.urls'
...
WSGI_APPLICATION = 'personality_aware_product_recommendation.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'personality_aware_product_recommendation',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
