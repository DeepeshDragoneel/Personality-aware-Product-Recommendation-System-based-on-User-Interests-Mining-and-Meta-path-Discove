...
--
-- Host: localhost
-- Generation Time: Nov 15, 2021 at 10:57 AM
...
--
-- Database: `personality_aware_product_recommendation`
--
CREATE DATABASE IF NOT EXISTS `personality_aware_product_recommendation` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `personality_aware_product_recommendation`;
...
('axmker8w0v3wwmfzbyi14z8vnnsbxhu6', 'eyJ1c2VyaWQiOjI1fQ:1mmZYS:BP9wNg06yAqW5b-pje4YcCQo20jYDYMaVBcIDGRM2No', '2021-11-29 10:49:40.822517'),
...
('d8cebldf9j0k9twit8vvrro7pebhbuhd', 'eyJ1c2VyaWQiOjExfQ:1mmYy3:6F4qz12w8XMml03cL6tDlVl3wckINWC1oBQrjq9wun4', '2021-11-29 10:12:03.515402'),
...
(25, 'Ashwini', 'Ashwini1213@gmail.com', 'Ashwini', '9535866270', 'India', 'Karnataka', 'Bangalore');
...
--
-- Table structure for table `remote_user_product_details`
--

CREATE TABLE IF NOT EXISTS `remote_user_product_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `idno` varchar(300) NOT NULL,
  `ProductId` varchar(300) NOT NULL,
  `UserId` varchar(300) NOT NULL,
  `ProfileName` varchar(300) NOT NULL,
  `HelpfulnessNumerator` varchar(300) NOT NULL,
  `HelpfulnessDenominator` varchar(300) NOT NULL,
...
--
-- Table structure for table `remote_user_recommend_prediction`
--

CREATE TABLE IF NOT EXISTS `remote_user_recommend_prediction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `idno` varchar(300) NOT NULL,
  `ProductId` varchar(300) NOT NULL,
  `UserId` varchar(300) NOT NULL,
  ...
  `Recommend_Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
